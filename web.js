...
// Configuration
const processingDomain = 'https://bituteh-v2.webflow.io';
const sitemapRealDomain = 'https://bituteh.com';
...
const urlsToRemove = [
  'https://agota.studio/',
  'https://agota.studio/services'
];

// Main Process
async function processSitemapAndResources() {
  await fetchSitemap();
  await fetchResourceLinksAndUpdateSitemap('/services', ['/services']);
  moveAndRenameResourcesFile(outputFolder, 'services.html', 'services');
